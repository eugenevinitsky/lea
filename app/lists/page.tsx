      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <a href="/" className="flex items-center gap-2 text-gray-900 dark:text-gray-100">
              <svg className="w-6 h-6 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
              </svg>
              <span className="font-bold text-lg">Lea</span>
            </a>
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                <h2 className="font-semibold text-gray-900 dark:text-gray-100">My Lists</h2>
                <button
                    ...
                    {lists.map((list) => (
                      <button
                        ...
                        className={`w-full p-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors ${
                          selectedList?.uri === list.uri ? 'bg-blue-50 dark:bg-blue-900/20' : ''
                        }`}
                      >
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-800">
                  <div className="flex items-start gap-4">
                    {selectedList.avatar ? (
                      <img src={selectedList.avatar} alt="" className="w-16 h-16 rounded-xl flex-shrink-0" />
                    ) : (
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white text-2xl font-bold flex-shrink-0">
                  ...
                  {loadingMembers ? (
                    ...
                    <div className="p-8 text-center">
                      ...
                      <p className="text-sm text-gray-400">
                        Add users to this list from their profile.
                      </p>
                    </div>
                  ) : (
                    <div className="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          >
            <div className="p-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Are you sure you want to delete &quot;{deletingList.name}&quot;? This action cannot be
                undone.
              </p>
