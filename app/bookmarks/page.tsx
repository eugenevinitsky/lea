      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex items-center gap-0.5 flex-shrink-0">
          {onTogglePin && (
            ...
            >
              <svg className={`w-4 h-4 ${bookmark.pinned ? 'text-blue-500' : 'text-gray-400'}`} viewBox="0 0 24 24" fill={bookmark.pinned ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={2}>
