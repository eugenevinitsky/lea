          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-full transition-colors flex items-center gap-1"
              >
                @{session?.handle}
              ...
              {showUserDropdown && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-20">
                    <button
                      onClick={() => {
                        setShowUserDropdown(false);
                        window.location.href = `/u/${session?.handle}`;
                      }}
      ...
      <div className="max-w-5xl mx-auto flex gap-4 px-0 lg:px-4">
        ...
        <aside className="hidden lg:block w-64 flex-shrink-0 sticky top-16 max-h-[calc(100vh-5rem)] overflow-y-auto pt-4 pb-4 space-y-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700">
          ...
          <button
            ...
            className="w-full py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-medium rounded-full flex items-center justify-center gap-2 transition-all shadow-sm"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
